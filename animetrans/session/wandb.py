...
class WandbLogger(BaseLogger):
    def __init__(self, workdir, project="animetrans", name=None, hyperparams: Optional[dict] = None, **kwargs):
    ...
    def wdb_log(self, global_step, data: Mapping[str, Union[float, Image.Image]]):
        if not self.active:
            return
